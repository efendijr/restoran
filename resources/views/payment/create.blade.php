...
<div class="container">
    ...
    <div class="clearfix">
        <div class="pull-left">
            <div class="lead">Buat Member Baru</div>
        </div>
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Buat memberan baru</div>
                
                <div class="panel-body">

                    <form class="form-horizontal" method="POST" action="{{ route('member.simpan')}}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        @include('member.form')
